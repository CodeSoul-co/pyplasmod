...
**简体中文。** 英文（默认）：[docs/plans/README.md](../../plans/README.md)。

本目录收录 **pyplasmod** 的架构说明与用户指南，供集成开发者与贡献者查阅。日常上手请从仓库根目录 [README.md](../../../README.zh-CN.md) 开始。
...
- [docs/zh-CN/SDK.md](../SDK.md)（实现细节与 API 速查）
- [docs/zh-CN/EMBEDDING.md](../EMBEDDING.md)（网关嵌入与 CPU/GPU，`PlasmodEmbedding`）
