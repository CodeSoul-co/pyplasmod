...
sed -i 's/import plasmod_pb2 as milvus__pb2/from . import plasmod_pb2 as milvus__pb2/' $OUTDIR/*py
...
sed -i 's/import plasmod_pb2 as _plasmod_pb2/from . import plasmod_pb2 as _plasmod_pb2/' $OUTDIR/*pyi
