...
from pyplasmod.client.types import GrantInfo, ResourceGroupConfig
...
from pyplasmod.orm.schema import Function, Highlighter
...
class AsyncGrpcHandler:
    ...
    async def reconnect(self, address: Optional[str] = None, timeout: float = 10):
        ...
        (AsyncPlasmodClient._handler, in-flight retry loops) continue to work.
    ...
    def _setup_grpc_channel(self, **kwargs):
        ...
        if self._log_level:
            ...
            self._log_level = None
        self._async_stub = plasmod_pb2_grpc.PlasmodServiceStub(self._final_channel)
    ...
    async def ensure_channel_ready(self, timeout: Optional[float] = None):
        try:
            if not self._is_channel_ready:
                ...
                self._async_stub = plasmod_pb2_grpc.PlasmodServiceStub(self._async_channel)
    ...
    def reset_db_name(self, db_name: str):
        ...
        Use AsyncPlasmodClient.use_database() instead.
        """
