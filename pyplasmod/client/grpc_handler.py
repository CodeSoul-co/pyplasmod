...
from pyplasmod.client.call_context import CallContext, _api_level_md
...
from pyplasmod.grpc_gen import common_pb2, plasmod_pb2_grpc
from pyplasmod.grpc_gen import plasmod_pb2 as plasmod_types
from pyplasmod.orm.schema import Function, FunctionScore, Highlighter
...
class GrpcHandler:
    ...
    def _wait_for_channel_ready(self, timeout: Optional[float] = 10):
        ...
        # to the default 10 s so that an unreachable URI raises PlasmodException
    ...
    def reconnect(self, address: Optional[str] = None, timeout: float = 10):
        ...
        (PlasmodClient._handler, in-flight retry loops) continue to work.
    ...
    def reset_db_name(self, db_name: str):
        ...
        Use PlasmodClient.use_database() instead.
        """
    ...
    def _setup_grpc_channel(self):
        ...
        if self._log_level:
            ...
            self._log_level = None
        self._stub = plasmod_pb2_grpc.PlasmodServiceStub(self._final_channel)
    ...
    def has_collection(
        ...
        **kwargs,
        ...
        # For compatibility with Plasmod less than 2.3.2, which does not support status.code.
        if (
        ...
        raise PlasmodException(reply.status.code, reply.status.reason, reply.status.error_code)
    ...
    def _prepare_batch_insert_request(
        ...
        **kwargs,
        ...
        if param and not isinstance(param, plasmod_types.InsertRequest):
    ...
    def _prepare_batch_upsert_request(
        ...
        **kwargs,
        ...
        if param and not isinstance(param, plasmod_types.UpsertRequest):
    ...
    def _execute_search(
        self,
        request: plasmod_types.SearchRequest,
        timeout: Optional[float] = None,
        context: Optional[CallContext] = None,
        **kwargs,
    ):
        try:
            ...
            if response is None:
                raise PlasmodException(message="Received None response from server during search")
            check_status(response.status)
    ...
    def get_query_segment_info(
        ...
        context: Optional[CallContext] = None,
        **kwargs,
    ) -> List[plasmod_types.QuerySegmentInfo]:
            ...
            def _check():
                if kwargs.get("sync", True):
                    ...
                    if not index_success:
                        raise PlasmodException(message=fail_reason)
    ...
    def list_indexes(
        ...
        **kwargs,
        ...
        if status.code == ErrorCode.INDEX_NOT_FOUND or status.error_code == Status.INDEX_NOT_EXIST:
            return []
        raise PlasmodException(status.code, status.reason, status.error_code)
    ...
    def get_persistent_segment_infos(
        ...
        context: Optional[CallContext] = None,
        **kwargs,
    ) -> List[plasmod_types.PersistentSegmentInfo]:
    ...
    def query(
        ...
        **kwargs,
        ...
        # check has fields
        if num_fields == 0:
            raise PlasmodException(message="No fields returned")
        ...
        if not all(len_of(field_data) == num_entities for field_data in it):
            raise PlasmodException(message="The length of fields data is inconsistent")
    ...
    def compact(
        ...
        **kwargs,
        ...
        if response.status.error_code == common_pb2.CollectionNameNotFound:
            # should be removed, but to be compatible with old plasmod server, keep it for now.
            request = Prepare.describe_collection_request(collection_name)
            response = self._stub.DescribeCollection(
                request, timeout=timeout, metadata=_api_level_md(context)
            )
    ...
    def add_user_to_role(
        ...
        **kwargs,
        ...
        req = Prepare.operate_user_role_request(
            username, role_name, plasmod_types.OperateUserRoleType.AddUserToRole
        )
    ...
    def remove_user_from_role(
        ...
        **kwargs,
        ...
        req = Prepare.operate_user_role_request(
            username, role_name, plasmod_types.OperateUserRoleType.RemoveUserFromRole
        )
        resp = self._stub.OperateUserRole(
            req,
            wait_for_ready=True,
    ...
    def grant_privilege(
        ...
        **kwargs,
        ...
        req = Prepare.operate_privilege_request(
            ...
            privilege,
            db_name,
            plasmod_types.OperatePrivilegeType.Grant,
        )
    ...
    def revoke_privilege(
        ...
        **kwargs,
        ...
        req = Prepare.operate_privilege_request(
            ...
            privilege,
            db_name,
            plasmod_types.OperatePrivilegeType.Revoke,
        )
        resp = self._stub.OperatePrivilege(
            req,
            wait_for_ready=True,
    ...
    def alloc_timestamp(
        ...
        **kwargs,
        ...
        request = plasmod_types.AllocTimestampRequest()
    ...
    def add_privileges_to_group(
        ...
        **kwargs,
        ...
        req = Prepare.operate_privilege_group_req(
            privilege_group, privileges, plasmod_types.OperatePrivilegeGroupType.AddPrivilegesToGroup
        )
    ...
    def remove_privileges_from_group(
        ...
        **kwargs,
        ...
        req = Prepare.operate_privilege_group_req(
            privilege_group,
            privileges,
            plasmod_types.OperatePrivilegeGroupType.RemovePrivilegesFromGroup,
        )
        resp = self._stub.OperatePrivilegeGroup(
            req,
            wait_for_ready=True,
    ...
    def get_replicate_configuration(
        ...
        **kwargs,
        ...
        """
        request = plasmod_types.GetReplicateConfigurationRequest()
    ...
    def get_restore_snapshot_state(
        ...
        **kwargs,
        ...
        # Note: If job_id doesn't exist, check_status will raise PlasmodException above
        info = response.info
        return RestoreSnapshotJobInfo(
            ...
            state=plasmod_types.RestoreSnapshotState.Name(info.state),
