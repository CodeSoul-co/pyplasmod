...
from pyplasmod._interop_names import grpc_replicate_cluster_message
from pyplasmod.exceptions import DataNotMatchException, ExceptionsMessage, ParamError
...
from pyplasmod.orm.types import infer_dtype_by_scalar_data
...
class Prepare:
    ...
    def create_collection_request(
        ...
        **kwargs,
    ) -> plasmod_types.CreateCollectionRequest:
        """
        Args:
            fields (Union(Dict[str, Iterable], CollectionSchema)).
        ...
        req = plasmod_types.CreateCollectionRequest(
    ...
    @classmethod
    def drop_collection_request(cls, collection_name: str) -> plasmod_types.DropCollectionRequest:
        return plasmod_types.DropCollectionRequest(collection_name=collection_name)

    @classmethod
    def truncate_collection_request(
        cls, collection_name: str
    ) -> plasmod_types.TruncateCollectionRequest:
        return plasmod_types.TruncateCollectionRequest(collection_name=collection_name)

    @classmethod
    def drop_collection_function_request(
        cls, collection_name: str, function_name: str
    ) -> plasmod_types.DropCollectionFunctionRequest:
        return plasmod_types.DropCollectionFunctionRequest(
    ...
    ) -> plasmod_types.AddCollectionFunctionRequest:
        function_schema = cls.convert_function_to_function_schema(f)
        return plasmod_types.AddCollectionFunctionRequest(
    ...
    ) -> plasmod_types.AlterCollectionFunctionRequest:
        function_schema = cls.convert_function_to_function_schema(f)
        return plasmod_types.AlterCollectionFunctionRequest(
            collection_name=collection_name,
    ...
    ) -> plasmod_types.AddCollectionFieldRequest:
        field_schema_proto, _, _ = cls.get_field_schema(field=field_schema.to_dict())
        return plasmod_types.AddCollectionFieldRequest(
            collection_name=collection_name,
    ...
    def describe_collection_request(
        cls,
        collection_name: str,
    ) -> plasmod_types.DescribeCollectionRequest:
        return plasmod_types.DescribeCollectionRequest(collection_name=collection_name)
    ...
    ) -> plasmod_types.AlterCollectionRequest:
        kvs = []
        if properties:
            kvs = [common_types.KeyValuePair(key=k, value=str(v)) for k, v in properties.items()]

        return plasmod_types.AlterCollectionRequest(
    ...
    def show_collections_request(cls, collection_names: Optional[List[str]] = None):
        ...
        if collection_names:
            ...
            req.type = plasmod_types.ShowType.InMemory
        return req

    @classmethod
    def rename_collections_request(cls, old_name: str, new_name: str, new_db_name: str):
        return plasmod_types.RenameCollectionRequest(
    ...
    def create_partition_request(cls, collection_name: str, partition_name: str):
        return plasmod_types.CreatePartitionRequest(
    ...
    def show_partitions_request(
        ...
        req = plasmod_types.ShowPartitionsRequest(collection_name=collection_name)
        if partition_names:
        ...
        if type_in_memory is False:
            req.type = plasmod_types.ShowType.All
        else:
            req.type = plasmod_types.ShowType.InMemory
        return req
    ...
    def get_loading_progress(
        ...
        check_pass_param(collection_name=collection_name, partition_name_array=partition_names)
        req = plasmod_types.GetLoadingProgressRequest(collection_name=collection_name)
        if partition_names:
            req.partition_names.extend(partition_names)
        return req
    ...
    def get_load_state(cls, collection_name: str, partition_names: Optional[List[str]] = None):
        check_pass_param(collection_name=collection_name, partition_name_array=partition_names)
        req = plasmod_types.GetLoadStateRequest(collection_name=collection_name)
        if partition_names:
            req.partition_names.extend(partition_names)
        return req
    ...
    def register_link_request(cls):
        return plasmod_types.RegisterLinkRequest()
    ...
    def partition_name(cls, collection_name: str, partition_name: str):
        ...
        return plasmod_types.PartitionName(collection_name=collection_name, tag=partition_name)
    ...
    def _parse_row_request(
        request: Union[plasmod_types.InsertRequest, plasmod_types.UpsertRequest],
    ...
    def row_insert_param(
        ...
        request = plasmod_types.InsertRequest(
            collection_name=collection_name,
    ...
    def row_upsert_param(
        ...
        request = plasmod_types.UpsertRequest(
            collection_name=collection_name,
            partition_name=p_name,
            num_rows=len(entities),
            schema_timestamp=schema_timestamp,
    ...
    def batch_insert_param(
        ...
        request = plasmod_types.InsertRequest(collection_name=collection_name, partition_name=tag)
    ...
    def delete_request(
        ...
        **kwargs,
        ...
        return plasmod_types.DeleteRequest(
            collection_name=collection_name,
    ...
    def search_requests_with_expr(
        ...
        **kwargs,
        ...
        request = plasmod_types.SearchRequest(**request_kwargs)
    ...
    def hybrid_search_request_with_ranker(
        ...
        use_default_consistency: bool = True,
        **kwargs,
    ) -> plasmod_types.HybridSearchRequest:
        ...
        request = plasmod_types.HybridSearchRequest(
            collection_name=collection_name,
            partition_names=partition_names,
            requests=reqs,
            output_fields=output_fields,
    ...
    def create_alias_request(cls, collection_name: str, alias: str):
        return plasmod_types.CreateAliasRequest(collection_name=collection_name, alias=alias)

    @classmethod
    def drop_alias_request(cls, alias: str):
        return plasmod_types.DropAliasRequest(alias=alias)

    @classmethod
    def alter_alias_request(cls, collection_name: str, alias: str):
        return plasmod_types.AlterAliasRequest(collection_name=collection_name, alias=alias)

    @classmethod
    def describe_alias_request(cls, alias: str):
        return plasmod_types.DescribeAliasRequest(alias=alias)

    @classmethod
    def list_aliases_request(cls, collection_name: str, db_name: str = ""):
        return plasmod_types.ListAliasesRequest(collection_name=collection_name, db_name=db_name)

    @classmethod
    def create_index_request(cls, collection_name: str, field_name: str, params: Dict, **kwargs):
        index_params = plasmod_types.CreateIndexRequest(
            collection_name=collection_name,
    ...
    def alter_index_properties_request(
        ...
        return plasmod_types.AlterIndexRequest(
    ...
    def describe_index_request(
        ...
        return plasmod_types.DescribeIndexRequest(
    ...
    def load_collection(
        ...
        **kwargs,
        ...
        check_pass_param(collection_name=collection_name)
        req = plasmod_types.LoadCollectionRequest(
            collection_name=collection_name,
        )
    ...
    def release_collection(cls, db_name: str, collection_name: str):
        return plasmod_types.ReleaseCollectionRequest(
    ...
    def load_partitions(
        ...
        **kwargs,
        ...
        check_pass_param(collection_name=collection_name)
        req = plasmod_types.LoadPartitionsRequest(
            collection_name=collection_name,
        )
    ...
    def release_partitions(cls, db_name: str, collection_name: str, partition_names: List[str]):
        return plasmod_types.ReleasePartitionsRequest(
    ...
    def get_collection_stats_request(cls, collection_name: str):
        return plasmod_types.GetCollectionStatisticsRequest(collection_name=collection_name)

    @classmethod
    def get_persistent_segment_info_request(cls, collection_name: str):
        return plasmod_types.GetPersistentSegmentInfoRequest(collectionName=collection_name)

    @classmethod
    def get_flush_state_request(cls, segment_ids: List[int], collection_name: str, flush_ts: int):
        return plasmod_types.GetFlushStateRequest(
    ...
    def get_query_segment_info_request(cls, collection_name: str):
        return plasmod_types.GetQuerySegmentInfoRequest(collectionName=collection_name)

    @classmethod
    def flush_param(cls, collection_names: List[str]):
        return plasmod_types.FlushRequest(collection_names=collection_names)

    @classmethod
    def drop_index_request(cls, collection_name: str, field_name: str, index_name: str):
        return plasmod_types.DropIndexRequest(
            db_name="",
            collection_name=collection_name,
            field_name=field_name,
    ...
    def get_partition_stats_request(cls, collection_name: str, partition_name: str):
        return plasmod_types.GetPartitionStatisticsRequest(
            db_name="", collection_name=collection_name, partition_name=partition_name
        )

    @classmethod
    def dummy_request(cls, request_type: Any):
        return plasmod_types.DummyRequest(request_type=request_type)
    ...
    def query_request(
        ...
        **kwargs,
        ...
        req = plasmod_types.QueryRequest(
            db_name="",
            collection_name=collection_name,
            expr=expr,
            output_fields=output_fields,
    ...
    def load_balance_request(
        ...
        return plasmod_types.LoadBalanceRequest(
    ...
    def manual_compaction(
        ...
        request = plasmod_types.ManualCompactionRequest(
            collection_name=collection_name,
    ...
    def get_compaction_state(cls, compaction_id: int):
        ...
        request = plasmod_types.GetCompactionStateRequest()
    ...
    def get_compaction_state_with_plans(cls, compaction_id: int):
        ...
        request = plasmod_types.GetCompactionPlansRequest()
        request.compactionID = compaction_id
        return request
    ...
    def get_replicas(cls, collection_id: int):
        ...
        return plasmod_types.GetReplicasRequest(
    ...
    def do_bulk_insert(cls, collection_name: str, partition_name: str, files: list, **kwargs):
        ...
        req = plasmod_types.ImportRequest(
            collection_name=collection_name,
            partition_name=partition_name,
            files=files,
        )
    ...
    def get_bulk_insert_state(cls, task_id: int):
        ...
        return plasmod_types.GetImportStateRequest(task=task_id)
    ...
    def list_bulk_insert_tasks(cls, limit: int, collection_name: str):
        ...
        return plasmod_types.ListImportTasksRequest(
            collection_name=collection_name,
            limit=limit,
        )
    ...
    def create_user_request(cls, user: str, password: str):
        ...
        return plasmod_types.CreateCredentialRequest(
    ...
    def update_password_request(cls, user: str, old_password: str, new_password: str):
        ...
        return plasmod_types.UpdateCredentialRequest(
            username=user,
    ...
    def delete_user_request(cls, user: str):
        ...
        return plasmod_types.DeleteCredentialRequest(username=user)

    @classmethod
    def list_usernames_request(cls):
        return plasmod_types.ListCredUsersRequest()

    @classmethod
    def create_role_request(cls, role_name: str):
        check_pass_param(role_name=role_name)
        return plasmod_types.CreateRoleRequest(entity=plasmod_types.RoleEntity(name=role_name))

    @classmethod
    def drop_role_request(cls, role_name: str, force_drop: bool = False):
        check_pass_param(role_name=role_name)
        return plasmod_types.DropRoleRequest(role_name=role_name, force_drop=force_drop)
    ...
    def operate_user_role_request(cls, username: str, role_name: str, operate_user_role_type: Any):
        ...
        return plasmod_types.OperateUserRoleRequest(
    ...
    def select_role_request(cls, role_name: str, include_user_info: bool):
        ...
        return plasmod_types.SelectRoleRequest(
            role=plasmod_types.RoleEntity(name=role_name) if role_name else None,
    ...
    def select_user_request(cls, username: str, include_role_info: bool):
        ...
        return plasmod_types.SelectUserRequest(
            user=plasmod_types.UserEntity(name=username) if username else None,
    ...
    def operate_privilege_request(
        ...
        return plasmod_types.OperatePrivilegeRequest(
            entity=plasmod_types.GrantEntity(
                role=plasmod_types.RoleEntity(name=role_name),
                object=plasmod_types.ObjectEntity(name=object),
                object_name=object_name,
                db_name=db_name,
                grantor=plasmod_types.GrantorEntity(
                    privilege=plasmod_types.PrivilegeEntity(name=privilege)
                ),
            ),
    ...
    def operate_privilege_v2_request(
        ...
        return plasmod_types.OperatePrivilegeV2Request(
            role=plasmod_types.RoleEntity(name=role_name),
            grantor=plasmod_types.GrantorEntity(
                privilege=plasmod_types.PrivilegeEntity(name=privilege)
            ),
    ...
    def select_grant_request(cls, role_name: str, object: str, object_name: str, db_name: str):
        ...
        if object_name:
            check_pass_param(object_name=object_name)
        return plasmod_types.SelectGrantRequest(
            entity=plasmod_types.GrantEntity(
                role=plasmod_types.RoleEntity(name=role_name),
                object=plasmod_types.ObjectEntity(name=object) if object else None,
    ...
    def update_resource_groups(cls, configs: Mapping[str, ResourceGroupConfig]):
        return plasmod_types.UpdateResourceGroupsRequest(
    ...
    def drop_resource_group(cls, name: str):
        check_pass_param(resource_group_name=name)
        return plasmod_types.DropResourceGroupRequest(resource_group=name)

    @classmethod
    def list_resource_groups(cls):
        return plasmod_types.ListResourceGroupsRequest()

    @classmethod
    def describe_resource_group(cls, name: str):
        check_pass_param(resource_group_name=name)
        return plasmod_types.DescribeResourceGroupRequest(resource_group=name)
    ...
    def transfer_node(cls, source: str, target: str, num_node: int):
        ...
        return plasmod_types.TransferNodeRequest(
    ...
    def transfer_replica(cls, source: str, target: str, collection_name: str, num_replica: int):
        check_pass_param(resource_group_name=source)
        check_pass_param(resource_group_name=target)
        return plasmod_types.TransferReplicaRequest(
    ...
    def flush_all_request(cls, db_name: str):
        return plasmod_types.FlushAllRequest(db_name=db_name)

    @classmethod
    def get_flush_all_state_request(cls, flush_all_ts: int, db_name: str):
        return plasmod_types.GetFlushAllStateRequest(flush_all_ts=flush_all_ts, db_name=db_name)
    ...
    def register_request(cls, user: str, host: str, **kwargs):
        ...
        if host is not None:
            this.host = host
        return plasmod_types.ConnectRequest(
            client_info=this,
        )

    @classmethod
    def create_database_req(cls, db_name: str, properties: Optional[dict] = None):
        req = plasmod_types.CreateDatabaseRequest(db_name=db_name)
    ...
    def drop_database_req(cls, db_name: str):
        check_pass_param(db_name=db_name)
        return plasmod_types.DropDatabaseRequest(db_name=db_name)

    @classmethod
    def list_database_req(cls):
        return plasmod_types.ListDatabasesRequest()

    @classmethod
    def alter_database_properties_req(cls, db_name: str, properties: Dict):
        check_pass_param(db_name=db_name)
        kvs = [common_types.KeyValuePair(key=k, value=str(v)) for k, v in properties.items()]
        return plasmod_types.AlterDatabaseRequest(db_name=db_name, properties=kvs)

    @classmethod
    def drop_database_properties_req(cls, db_name: str, property_keys: List[str]):
        check_pass_param(db_name=db_name)
        return plasmod_types.AlterDatabaseRequest(db_name=db_name, delete_keys=property_keys)

    @classmethod
    def describe_database_req(cls, db_name: str):
        check_pass_param(db_name=db_name)
        return plasmod_types.DescribeDatabaseRequest(db_name=db_name)

    @classmethod
    def create_privilege_group_req(cls, privilege_group: str):
        check_pass_param(privilege_group=privilege_group)
        return plasmod_types.CreatePrivilegeGroupRequest(group_name=privilege_group)

    @classmethod
    def drop_privilege_group_req(cls, privilege_group: str):
        check_pass_param(privilege_group=privilege_group)
        return plasmod_types.DropPrivilegeGroupRequest(group_name=privilege_group)

    @classmethod
    def list_privilege_groups_req(cls):
        return plasmod_types.ListPrivilegeGroupsRequest()
    ...
    def operate_privilege_group_req(
        ...
        return plasmod_types.OperatePrivilegeGroupRequest(
            group_name=privilege_group,
            privileges=[plasmod_types.PrivilegeEntity(name=p) for p in privileges],
    ...
    def run_analyzer(
        ...
        req = plasmod_types.RunAnalyzerRequest(with_hash=with_hash, with_detail=with_detail)
    ...
    def update_replicate_configuration_request(
        ...
        if clusters is not None:
            for cluster_config in clusters:
                cluster = grpc_replicate_cluster_message(common_types)()
        ...
        return plasmod_types.UpdateReplicateConfigurationRequest(
    ...
    def create_snapshot_req(
        ...
        if (
            ...
            raise ParamError(message=msg)
        return plasmod_types.CreateSnapshotRequest(
            name=snapshot_name,
            db_name=db_name,
            collection_name=collection_name,
    ...
    def drop_snapshot_req(
        ...
        if not validate_str(collection_name):
            msg = "collection_name must be a non-empty string"
            raise ParamError(message=msg)
        return plasmod_types.DropSnapshotRequest(
            name=snapshot_name,
            db_name=db_name,
            collection_name=collection_name,
        )
    ...
    def list_snapshots_req(cls, collection_name: str = "", db_name: str = ""):
        return plasmod_types.ListSnapshotsRequest(
            db_name=db_name,
            collection_name=collection_name,
        )
    ...
    def describe_snapshot_req(
        ...
        if not validate_str(collection_name):
            msg = "collection_name must be a non-empty string"
            raise ParamError(message=msg)
        return plasmod_types.DescribeSnapshotRequest(
            name=snapshot_name,
            db_name=db_name,
            collection_name=collection_name,
        )
    ...
    def restore_snapshot_req(
        ...
        if not validate_str(source_collection_name):
            ...
            raise ParamError(message=msg)
        return plasmod_types.RestoreSnapshotRequest(
            name=snapshot_name,
    ...
    def get_restore_snapshot_state_req(cls, job_id: int):
        if not isinstance(job_id, int) or job_id <= 0:
            ...
            raise ParamError(message=msg)
        return plasmod_types.GetRestoreSnapshotStateRequest(job_id=job_id)

    @classmethod
    def list_restore_snapshot_jobs_req(cls, collection_name: str = "", db_name: str = ""):
        return plasmod_types.ListRestoreSnapshotJobsRequest(
            db_name=db_name,
            collection_name=collection_name,
        )
    ...
    def pin_snapshot_data_req(
        ...
        if not isinstance(ttl_seconds, int) or isinstance(ttl_seconds, bool) or ttl_seconds < 0:
            ...
            raise ParamError(message=msg)
        return plasmod_types.PinSnapshotDataRequest(
            name=snapshot_name,
            db_name=db_name,
            collection_name=collection_name,
    ...
    def unpin_snapshot_data_req(cls, pin_id: int):
        if not isinstance(pin_id, int) or isinstance(pin_id, bool) or pin_id <= 0:
            ...
            raise ParamError(message=msg)
        return plasmod_types.UnpinSnapshotDataRequest(pin_id=pin_id)

    @classmethod
    def add_file_resource(cls, name: str, path: str):
        return plasmod_types.AddFileResourceRequest(name=name, path=path)

    @classmethod
    def remove_file_resource(cls, name: str):
        return plasmod_types.RemoveFileResourceRequest(name=name)

    @classmethod
    def list_file_resources(cls):
        return plasmod_types.ListFileResourcesRequest()
    ...
    def refresh_external_collection_request(
        ...
        external_source: str = "",
        external_spec: str = "",
    ) -> plasmod_types.RefreshExternalCollectionRequest:
        return plasmod_types.RefreshExternalCollectionRequest(
            db_name=db_name,
            collection_name=collection_name,
    ...
    def get_refresh_external_collection_progress_request(
        cls,
        job_id: int,
    ) -> plasmod_types.GetRefreshExternalCollectionProgressRequest:
        return plasmod_types.GetRefreshExternalCollectionProgressRequest(
            job_id=job_id,
        )
    ...
    def list_refresh_external_collection_jobs_request(
        ...
        db_name: str = "",
        collection_name: str = "",
    ) -> plasmod_types.ListRefreshExternalCollectionJobsRequest:
        return plasmod_types.ListRefreshExternalCollectionJobsRequest(
            db_name=db_name,
            collection_name=collection_name,
        )
