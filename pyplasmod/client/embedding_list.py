...
class EmbeddingList:
    """
    A container for multiple embeddings that can be used directly in Plasmod searches.
    ...
    def to_flat_array(self) -> np.ndarray:
        """
        Convert to flat array format required by Plasmod for array-of-vector fields.
