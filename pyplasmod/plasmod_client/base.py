"""Base class for Plasmod clients."""

import logging
from typing import Dict, List

from pyplasmod.client.call_context import CallContext
from pyplasmod.client.constants import CLUSTER_ID
from pyplasmod.orm.collection import CollectionSchema, FieldSchema
...
class BasePlasmodClient:
    """Base class for Plasmod clients (synchronous and asynchronous)."""
    ...
    def get_server_type(self) -> str:
        ...
        Returns:
            str: The server type (e.g., "plasmod", "zilliz").
        """
