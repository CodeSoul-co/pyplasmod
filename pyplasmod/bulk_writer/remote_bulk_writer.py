...
from pyplasmod.orm.schema import CollectionSchema
...
class RemoteBulkWriter(LocalBulkWriter):
        ...
        if isinstance(self._connect_param, RemoteBulkWriter.S3ConnectParam):
            ...
            try:
                if (
                    ...
                    raise PlasmodException(message="Illegal connection parameters")
    ...
    def _stat_object(self, object_name: str):
        ...
        raise PlasmodException(message="Blob storage client is not initialized")
