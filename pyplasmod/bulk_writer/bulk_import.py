...
def bulk_import(
    ...
    **kwargs,
    ...
    Args:
        ...
        cluster_id (str): id of a plasmod instance(cloud)
    ...
    Examples:
        >>> # 1. Import multiple files into an open-source Plasmod instance
        >>> bulk_import(
...
def get_import_progress(
    ...
    **kwargs,
    ...
    Args:
        url (str): url of the server
        job_id (str): a job id
        cluster_id (str): id of a plasmod instance(for cloud)
        api_key (str): API key to authenticate your requests.
