...
from pyplasmod.client.types import FunctionType, HighlightType
from pyplasmod.client.utils import convert_struct_fields_to_user_format
...
class CollectionSchema:
    ...
    def fields(self):
        ...
        :example:
            >>> from pyplasmod import FieldSchema, CollectionSchema, DataType
            >>> field = FieldSchema("int64", DataType.INT64, description="int64", is_primary=True)
            >>> schema = CollectionSchema(fields=[field])
            >>> schema.fields
            [<pyplasmod.schema.FieldSchema object at 0x7fd3716ffc50>]
        """
        return self._fields
...
class FieldSchema:
    ...
    def description(self):
        ...
        :example:
        >>> from pyplasmod import FieldSchema, DataType
