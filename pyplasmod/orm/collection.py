...
from pyplasmod.client.constants import DEFAULT_CONSISTENCY_LEVEL
...
class Collection:
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            using (``str``, optional): Plasmod connection alias name, defaults to 'default'.
            **kwargs (``dict``):
        ...
        Examples:
            >>> from pyplasmod import Collection, FieldSchema, CollectionSchema, DataType
            >>> fields = [
    ...
    def construct_from_dataframe(cls, name: str, dataframe: pd.DataFrame, **kwargs):
        ...
        using = kwargs.get("using", Config.PLASMOD_CONN_ALIAS)
        ...
        **kwargs,
        ...
        Returns:
            MutationResult: contains 2 properties `insert_count`, and, `primary_keys`
                `insert_count`: how may entites have been inserted into Plasmod,
        ...
        **kwargs,
        ...
        Returns:
            MutationResult: contains 2 properties `upsert_count`, and, `primary_keys`
                `upsert_count`: how may entites have been upserted at Plasmod,
    ...
    def search(
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs (``dict``): Optional search params
                ...
                * *guarantee_timestamp* (``int``, optional)
                    Instructs Plasmod to see all operations performed before this timestamp.
                    By default Plasmod will search all operations performed to date.
        ...
        .. _Metric type documentations:
            https://plasmod.io/docs/v2.2.x/metric.md
        .. _Index documentations:
            https://plasmod.io/docs/v2.2.x/index.md
        .. _How guarantee ts works:
            https://github.com/plasmod-io/plasmod/blob/master/docs/developer_guides/how-guarantee-ts-works.md
    ...
    def index(self, **kwargs) -> Index:
        ...
        Examples:
            ...
            >>> collection.indexes
            [<pyplasmod.index.Index object at 0x7f4435587e20>]
            >>> collection.index()
            <pyplasmod.index.Index object at 0x7f44355a1460>
        """
    ...
    def alter_index(
        ...
        **kwargs,
        ...
        Examples:
            >>> from pyplasmod import Collection, FieldSchema, CollectionSchema, DataType
            >>> from pyplasmod import IndexType, MetricType
            >>> schema = CollectionSchema([
            ...     FieldSchema("film_id", DataType.INT64, is_primary=True),
    ...
    def drop_index(self, timeout: Optional[float] = None, **kwargs):
        ...
        Examples:
            >>> from pyplasmod Collection, FieldSchema, CollectionSchema, DataType
            >>> schema = CollectionSchema([
            ...     FieldSchema("film_id", DataType.INT64, is_primary=True),
            ...     FieldSchema("films", dtype=DataType.FLOAT_VECTOR, dim=2)
            ... ])
