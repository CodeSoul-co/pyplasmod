...
from pyplasmod.client.types import Replica
...
class Partition:
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(collection, Collection):
            ...
            msg = "Collection must be of type pyplasmod.Collection or String"
    ...
    def description(self) -> str:
        ...
        Examples:
            >>> from pyplasmod import connections, Collection, Partition
            >>> connections.connect()
    ...
    def num_entities(self) -> int:
        ...
        Examples:
            ...
            >>> connections.connect()
            >>> from pyplasmod import Collection, Partition, FieldSchema, CollectionSchema, DataType
