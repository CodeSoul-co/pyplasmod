...
import pytest
from pyplasmod.exceptions import ConnectionConfigException
from pyplasmod.plasmod_client._utils import create_connection


class TestCreateConnectionAlias:
    def test_explicit_alias_reuses_existing(self):
        with patch("pyplasmod.plasmod_client._utils.connections") as mock_conns:
...
class TestCreateConnectionAsync:
    def test_no_running_loop_raises(self):
        with patch("pyplasmod.plasmod_client._utils.connections"):
            with patch(
                "pyplasmod.plasmod_client._utils.asyncio.get_running_loop",
