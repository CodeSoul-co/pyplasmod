...
if utility.has_collection("hello_plasmod"):
    utility.drop_collection("hello_plasmod")
    print(f"Dropping existing collection hello_plasmod")
...
class PlasmodMultiThreadingInsert:
...
if __name__ == "__main__":
    multithreading_insert = PlasmodMultiThreadingInsert("hello_plasmod", 10)
