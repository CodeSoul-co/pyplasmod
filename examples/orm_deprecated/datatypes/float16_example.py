...
def fp16_vector_search():
    ...
    hello_plasmod = Collection("hello_plasmod_fp16", schema)
    ...
    for i, index_type in enumerate(fp16_index_types):
        ...
        res = hello_plasmod.search(vectors[0:10], vector_field_name, {"metric_type": "L2"}, limit=1, output_fields=["float16_vector"])
