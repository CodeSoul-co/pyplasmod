...
# ---- Schema ----
schema = plasmod_client.create_schema(enable_dynamic_field=True, auto_id=True)
...
struct_schema = plasmod_client.create_struct_field_schema()
...
plasmod_client.create_index(COLLECTION_NAME, schema=schema, index_params=index_params)

coll = plasmod_client.describe_collection(COLLECTION_NAME)
...
print("\n=== EmbeddingList Search ===")
res = plasmod_client.search(COLLECTION_NAME, data=queries, limit=10,
...
res = plasmod_client.search(COLLECTION_NAME, data=query_vec, limit=10,
